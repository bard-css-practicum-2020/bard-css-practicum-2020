  ...
  <WindupChildren>
    <Pace ms={80}>
      ...
      >
        ...
        <InterviewQuestion
          homepage={true}
          interviewer="Elizaveta Shneyderman (ES)​"
        >
        ...
        <InterviewAnswer homepage={true} subject="Tung-Hui Hu (THH)">
        ...
        <InterviewQuestion homepage={true} interviewer="ES">
        ...
        <InterviewAnswer homepage={true} subject="THH">
...
export default ElizavetaShneyderman
