...
const MuhebEsmatProject = () => (
  ...
  >
    ...
    <p>
      ...
      and material on the internet that is against Islam.” Although that ban was
      an extreme measure on the surface, an important fact to remember is that
      even before the decree there was very little public access to the
      internet. As a consequence of a war that had lasted more than two decades
      at the time, the telecommunication infrastructures were in an extremely
      debilitated state. Besides some foreign agencies and select wealthy
      Afghans that might have had access, it is reported that at the time it was
      “practically impossible to connect to the internet using Afghanistan's
      country code.”
    </p>
    <p>
    ...
    <p>
      ...
      aspects of an extended self usually separated in space and time,” such as
      images, news, and family connection. Through this virtual sphere, a new
      Afghan nation has risen, one in which citizenship is available to all that
      have a social media account, no matter how geographically and culturally
      far away they might be situated.
    </p>
    <p>
      ...
      cultural production, and self-shaping,” it is important to emphasize that
      these analyses are by no means a glorification of a corporation that is
      widely known for its abuse of power and lack of transparency. My analysis
      only covers a small part of a much larger phenomenon in an attempt at
      understanding its role in contemporary Afghanistan, without delving into
      the debate surrounding Facebook’s problems as a corporation built on
      commodifying our virtual presence and data.{" "}
    </p>
    <p>
      ...
      the eyes of strangers.” Therefore, there is the desire to mask one’s
      identity online for many reasons, in particular for women living inside
      the country, as their public presence is subject to an array of cultural,
      religious, and political boundaries. On the other hand, these
    ...
    <p>Connection across Boundaries:</p>
    <figure>
      <img src={GeneralMiaAndMariamSrc} alt="alt" />
      <figcaption>
        Fig. 1. Screenshot of conversation between Raees Mariam and General Mia,
        uploaded to YouTube by funny video.
      </figcaption>
    </figure>
    <br />
    <p>
      ...
      efforts meant to overcome the crippling sorrow of estrangement.” In
      Mariam’s case, the virtual sphere allows her to mediate this estrangement
      that comes with being physically distanced from the culture and place she
      used to call home and find an alternative space through which to connect
      to it. Through the years Mariam has come to use her platform to advocate
      for her rights as a woman and everyone’s right to choose the life they
      ...
      courageous act that has made her the direct target of both men and women,
    ...
    <figure>
      ...
      />
      <figcaption>
        Fig. 2. Screenshot of Mariam's livestream on YouTube channel Funny 420.
      </figcaption>
    </figure>
    <br />
    <p>
    ...
    <p>
      ...
      camcorder).” The genre has expanded drastically in recent decades and
      includes a wide range of examples that go from talk shows to talent and
      game shows, courtrooms, reality soap operas, and confined dramatization of
      a search for love. Because of the category’s fluid and expandable
      boundaries, it is both able to absorb new forms and also avoid being bound
      to a particular definition. An important factor in the genre's appeal and
      success is the ideology of the “real” that serves as an anchor to all
      forms that have evolved from it. In the past two decades, Afghan
      television viewers have been witness to several reality-based shows that
      include: Afghan Star (a talent show based on American Idol), a local
      adaptation of The Voice, Who Wants to Be a Millionaire, Khanda Bazar
      (similar to Afghan Star but solely for comedians), and cop shows that mix
    ...
    <p>
      ...
      producers are the “the omnipresent yet invisible cameramen” that also
      foreground their moral imperatives about Mariam and other personalities
      characters through their selection. In essence, this whole process, which
      starts with Mariam going Live and ends on YouTube channels with hundreds
      of thousands of views, travels through a list of complex social and
      political forces that leave their distinct mark in each step. The reality
      shows that have been taking shape surrounding livestreams in Afghan
      society teach us lessons about virtual connections and also reflect a new
      era of Afghan media production. Mariam and her peers have ushered in a new
      era of community building across social and physical borders through the
      virtual sphere. Such communities do not replace the necessity of the real
      sphere of in-person communication, but rather indicate the expansion,
      through livestreams, of the fields of communication and community building
      in the face of exile and physical and cultural boundaries.
    </p>
    <p>
    ...
    <div className="bibliography">
      <p>Bibliography</p>
      <p>
        Ansary, Tamim. Games without Rules: The Often-Interrupted History of
        Afghanistan. New York: Public Affairs, 2014.
      </p>
      <p>
        Holmes, Su, and Deborah Jermyn. Understanding Reality Television.
        London: Routledge, 2004.
      </p>
      <p>
        Kavka, Misha. “Love ’n the Real; or, How I Learned to Love Reality TV.”
        In The Spectacle of the Real: From Hollywood to “Reality” TV and Beyond,
        edited by Geoff King, 93–104. Bristol, UK / Portland, Or: Intellect,
        2005.
      </p>
      <p>
        McKay, Deirdre. “On Facebook.” An Archipelago of Care: Filipino Migrants
        and Global Networks, 51–69. Bloomington, IN: Indiana University Press,
        2016. DOI: 10.2307/j.ctt2005rbn.9.
      </p>
      <p>
        Said, Edward W. Reflections on Exile and Other Essays. London: Granta
        Books, 2012.
      </p>
      <p>
        BBC News, “Taleban ‘Outlaw Internet,’” July 13, 2001.
